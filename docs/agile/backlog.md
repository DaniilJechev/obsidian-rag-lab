...
| GRAPH-001 | P1 | idea | 11 | Добавить LangGraph workflow | Phase 11 planned: Sprint 24 каркас ([#64](https://github.com/DaniilJechev/obsidian-rag-lab/issues/64)), Sprint 25 rewrite/self-check ([#65](https://github.com/DaniilJechev/obsidian-rag-lab/issues/65)); Milestone [11](https://github.com/DaniilJechev/obsidian-rag-lab/milestone/11). Status остаётся `idea` до старта кода на sprint/24. |
