"""Deterministic Sprint 9 chunking experiments and MLflow artifacts."""
...
def collect_metrics(
    ...
    *,
    ...
    offset_violations = sum(
        ...
        or chunk.end_offset > source_lengths.get(chunk.section_id, float("inf"))
        for chunk in chunks
    )
...
def log_experiment_to_mlflow(
    ...
    *,
    ...
    """Log one result and its artifacts to the configured local MLflow store."""
